README.md — модуль user_interface
user_interface — это модуль консольного интерфейса для системы управления учебными задачами студентов (Student Task System).
